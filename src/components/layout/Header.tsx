        ...
        <header className="bg-white border-b border-neutral-200/70">
            <div className="container mx-auto flex items-center justify-between gap-6 px-4 py-4">
                ...
                <div className="hidden md:flex items-center gap-4">
                    {user ? (
                        <NavLink to="/minasidor" className={({ isActive }) => `inline-flex items-center gap-3 rounded-full border border-neutral-200 bg-white px-2 py-2 pr-4 text-sm font-medium text-neutral-800 shadow-sm transition-colors hover:border-neutral-300 hover:bg-neutral-50 ${isActive ? 'border-neutral-300 bg-neutral-100' : ''}`}>
                        ...
                        <NavLink to="/auth" className={({ isActive }) => `inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-neutral-800 hover:text-neutral-950 transition-colors duration-200 ${isActive ? 'font-semibold' : ''}`}>
                            Logga in
